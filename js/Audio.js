...
export class AudioPlayer extends AudioGain {
    constructor(options) {
        super({
            file: REQUIRED,
            loop: false,
...
export class AudioLoop extends AudioPlayer {
    constructor(options) {
        super({
            gain: 1,
            loop: true,
...
export class AudioTrigger extends AudioPlayer {
    constructor(options) {
        super({
            ...options
        })
